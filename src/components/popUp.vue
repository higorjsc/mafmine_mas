...
<script>
import vueCreditos from "@/components/creditos.vue"
import vueReportarErro from "@/components/reportarErro.vue"
import vueReferencias from "@/components/referencias.vue"
export default {
    components: {
        vueCreditos,
        vueReferencias,
